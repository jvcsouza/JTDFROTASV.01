...
namespace JTDFROTAS {
    ...
    public class Viagem : ReportClass {
    ...
    public class CachedViagem : Component, ICachedReport {
        
        public CachedrptViagem() {
        }
